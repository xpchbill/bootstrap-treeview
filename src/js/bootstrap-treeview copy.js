;(function ($, window, document, undefined) {
	...
	*/
	...
	Tree.prototype.clickAddNewLink = function (target) {
	...
	Tree.prototype.clickAddNewSave = function (target) {
		var container = target.closest('.tree-add-new-container');
	...
	Tree.prototype.clickAddNewCancel = function (target) {
		var container = target.closest('.tree-add-new-container');
		container.empty();
		container.append(this.template.addNewLink);
	}
	...
	Tree.prototype.buildTree = function (nodes, level) {
		...
		if(!nodes.length) {
			var addNewItem = $(_this.template.addNew)
